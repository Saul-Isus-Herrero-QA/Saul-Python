...
class CLIApplication:
    ...
    def show_welcome(self) -> None:
        ...
        print("\n" + "=" * 40)
        print("    GESTOR DE TAREAS v2.1 PRO")
        print("=" * 40)
    ...
    def handle_add(self) -> None:
        ...
        try:
            description = input("✏️  Escribe una tarea para tu lista: ").strip()
    ...
    def handle_delete(self) -> None:
        ...
        try:
            self.list_tasks()
            user_input = input("🗑️  Introduce el número de la tarea a eliminar: ").strip()
